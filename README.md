...
Драйвер создаёт misc-устройство `/dev/gfrandom`, которое возвращает псевдослучайные байты, сгенерированные с использованием арифметики Galois Field GF(2⁸). Является аналогом `/dev/urandom`.
