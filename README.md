...
- **lib** — [библиотека для работы с полями Галуа](https://github.com/DenisPotapov0/Galua-Field-library) (MIT License)
...
Эти же файлы используются в тестах №1 и №2. Первые 10 ожидаемых случайных байтов: `Gkwy\`..?..` (HEX: `47 6b 77 79 60 1c bd 3f c9 b2`) — см. `assets/expected1.bin`.
